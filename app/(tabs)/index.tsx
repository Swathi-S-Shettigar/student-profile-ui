...
//           @theo_from_hsr
//         </Text>
//         <Text style={{ color: "#888", fontSize: 14 }}>🇮🇳 INDIA</Text>
//         <Text style={{ color: "white", marginTop: 5, textAlign: "center" }}>
//           18 y/o with high ambitions. want to build cool stuff!
//         </Text>
//         <TouchableOpacity>
//           <Text style={{ color: "#1db954", marginTop: 5, fontWeight: "bold" }}>EDIT PROFILE</Text>
//         </TouchableOpacity>
//         <Text style={{ color: "white", marginTop: 5 }}>2 FOLLOWING</Text>
//       </View>

//       {/* Tabs */}
//       <View style={{ flexDirection: "row", justifyContent: "center", marginBottom: 10 }}>
//         <TouchableOpacity style={{ padding: 10, borderBottomWidth: 2, borderBottomColor: "#1db954" }}>
//           <Text style={{ color: "white" }}>COLLECTIONS</Text>
//         </TouchableOpacity>
//         <TouchableOpacity style={{ padding: 10 }}>
//           <Text style={{ color: "white" }}>MANAGE TAGS</Text>
//         </TouchableOpacity>
//       </View>
...
//           <Text style={{ color: "white", textAlign: "center", marginTop: 5 }}>LIKED (32)</Text>
//         </View>
//         <View style={{ width: "45%", marginBottom: 10 }}>
//           <Image source={{ uri: "https://via.placeholder.com/150" }} style={{ width: "100%", height: 100, borderRadius: 10 }} />
//           <Text style={{ color: "white", textAlign: "center", marginTop: 5 }}>SAVED (23)</Text>
//         </View>
//         <View style={{ width: "45%", marginBottom: 10 }}>
//           <Image source={{ uri: "https://via.placeholder.com/150" }} style={{ width: "100%", height: 100, borderRadius: 10 }} />
//           <Text style={{ color: "white", textAlign: "center", marginTop: 5 }}>FILES (3)</Text>
//         </View>
//       </View>
//     </ScrollView>
//   );
...
// } from "react-native";
// import { Ionicons, Feather } from "@expo/vector-icons";
// //import coverImage from "./assets/images/cover1.png"; // make sure the path is correct
...
//             @theo_from_hsr
//           </Text>
//           <Text style={{ color: "#ccc", fontSize: 14 }}>🇮🇳 INDIA</Text>
//           <Text
//             style={{
//               color: "white",
//               marginTop: 5,
...
//         <View style={{ width: "45%", marginBottom: 10 }}>
//           <Image
//               source={require("../../assets/images/saved.jpg")}
...
//         <View style={{ width: "45%", marginBottom: 10 }}>
//           <Image
//                         source={require("../../assets/images/files.jpg")}
